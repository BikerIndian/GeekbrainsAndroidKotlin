package ru.geekbrains.AndroidKotlin.presentation.main.custom
...
import ru.geekbrains.AndroidKotlin.ant.dip
...
class ColorCircleView @JvmOverloads constructor(context: Context,
    ...
    @ColorRes var strokeColorRes: Int = R.color.color_green
        set(value) {
            field = value
    ...
    init {
        ...
        strokeColorRes = a.getResourceId(
                R.styleable.ColorCircleView_strokeColor, R.color.color_white)
        a.recycle()
    }
